...
/*
I was able to find a similar solution in Python and adopted it for 
JS. Created an object with the appropiate key:value pairs. I used
a for loop to loop through the 'dna' string and I stored each value
in the variable value, then added it to the empty string initialized
outside of the loop. I then had the function return that string. 
